    ...
    <div className="border-b-2 py-2 border-gray-200 px-10 flex justify-between ">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span className="absolute top-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-[#1391AE] group-hover:h-full ease"></span>
          <span className="absolute bottom-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-[#1391AE]group-hover:h-full ease"></span>
          <span className="absolute inset-0 w-full h-full duration-300 delay-300 bg-[#1391AE] opacity-0 group-hover:opacity-100"></span>
          <span className="relative transition-colors duration-300 delay-200 group-hover:text-white ease">
            Create
          </span>
        </button>

        <Avatar size={"big"} name="Rishit" />
      </div>
    </div>
  );
};
